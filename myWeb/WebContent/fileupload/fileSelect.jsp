...
<script>
function inputValue(form1, param, from2, idx){
...
function addFile(formName){
	if(formName.addcnt.value==""){
		alert("입력한 파일 갯수를 입력하고 확인버튼을 눌러주세요");
	...
	for(idx=0; idx<formName.elements.length; idx++){
		if(formName.elements[idx].type == "file"){
			if(formName.elements[idx].value==""){
				var message = paramIndex +"번쨰 파일정보가 누락되었습니다.\n 업로드할 파일을 선택해 주세요.";
				alert(message);
...
<div align="center">
	...
	복수개의 파일의 업로드를 위하여 파일 갯수를 입력한 후<br>확인 버튼을 눌러주세요!!!<br>
	...
	<table width="75%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#660000" bgcolor="#FFFF99">
		<tr bgcolor="#FFCC00">
			...
			<td><input type="text" name="title" 
				onkeyup="inputValue(this.form,user,frmName2,1)" 
